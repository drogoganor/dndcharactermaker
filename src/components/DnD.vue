  ...
  <div class='bd-main-container container'>
    ...
    <div class='content has-text-left'>
      <div class='columns field'>
        <label class='column is-2 label'>Level:</label>
        <div class='column is-1' id="level">{{ level }}</div>
      </div>
      <div class='columns field'>
        <label class='column is-2 label'>XP:</label>
        ...
        <div id="character-race">
          <div class="buttons are-small has-addons">
            <button
              ...
              :class="['button', { 'is-link is-selected': output.race === race.text }]"
            >{{ race.text }}</button>
          </div>
        </div>
      </div>
        ...
        <div id="character-class">
          <div class="buttons are-small has-addons">
            <button
              ...
              :class="['button', { 'is-link is-selected': output.class === cls.text }]"
            >{{ cls.text }}</button>
          </div>
        </div>
      </div>
      <div class='field'>
        <label class='label'>Law/Chaos:</label>
        <div id="character-alignment1">
          <div class="buttons are-small has-addons">
            <button
              ...
              :class="['button', { 'is-link is-selected': output.alignmentLawChaos === align.text }]"
            >{{ align.text }}</button>
          </div>
        </div>
      </div>
      <div class='field'>
        <label class='label'>Good/Evil:</label>
        <div id="character-alignment2">
          <div class="buttons are-small has-addons">
            <button
              ...
              :class="['button', { 'is-link is-selected': output.alignmentGoodEvil === align.text }]"
            >{{ align.text }}</button>
          </div>
        </div>
      </div>
        ...
        <div id="character-background">
          <div class="buttons are-small has-addons">
            <button
              ...
              :class="['button', { 'is-link is-selected': output.background === bg.text }]"
            >{{ bg.text }}</button>
          </div>
        </div>
      </div>
      <div class='columns field' v-if="toolProficienciesText !== ''">
        <label class='column is-2 label'>Tool Proficiencies:</label>
        <div class='column' id="toolProfs">
          <span class='tag is-dark'>{{ toolProficienciesText }}</span>
        </div>
      </div>
      <div class='columns field'>
        <label class='column is-2 label'>Currency:</label>
        <div class='column' id="currency">{{ currencyText }}</div>
      </div>
      <div class='columns'>
        <label class='column is-2 label'>Stats:</label>
      ...
      <div class='columns field' v-if='statRolls.length > 0'>
      ...
      <div class='columns field'>
        <label class='column is-2 label'>Reset Stats:</label>
        <div class='column'>
      ...
      <div class='columns field'>
        <label class='column is-2 label'>Proficiencies:</label>
        <div class='column' id="proficiencies">
          ...
          <div v-if="!allProficienciesChosen">
            <label class='label'>{{ proficiencesLeftText }}</label>
        ...
        <div class='column tags are-small'>
          ...
          <div v-for="choices in equipmentChoiceModel" v-bind:key="choices.id">
            <span v-for="choice in choices.choices" v-bind:key="choice.id" class='buttons are-small'>
                ...
                <button type="button" v-for="item in choice.items" v-bind:key="item.id" class='button is-link' v-on:click="selectEquipment(choices.id, choice.id, item)">{{ getEquipmentName(item) }}</button>
      ...
      <div class='columns field'>
        <label class='column is-2 label'>Languages:</label>
        <div class='column tags are-small'>
          <div class='tags are-small'>
            <span
          ...
          <div v-if="!allLanguagesChosen">
            <label class='label'>{{ languagesLeftText }}</label>
            <div class='buttons are-small'>
              <button
                type="button"
                class='button is-link'
      ...
      <div id="finish">
        <button
          ...
          :class="['button is-large', { 'is-outlined': !allChoicesFulfilled, 'is-success': allChoicesFulfilled }]"
        >Generate PDF</button>
      </div>
